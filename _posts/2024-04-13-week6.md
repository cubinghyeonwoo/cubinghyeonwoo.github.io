...
| 함수명 | 기능 |
| :--------------- | ------- |
| textinput(title, prompt) | <ul><li>문자열 입력을 위한 대화상자를 띄우는 함수</li><li> • tltle : 대화상자 창 제목/li></ul> • prompt : 입력해야 할 정보 설명하는 텍스트/li></ul> |
| numinput(title, prompt) | 숫자 입력을 위한 대화상자 띄우는 함수 |

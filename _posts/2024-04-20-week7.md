...
| if 조건문 : <br>     수행할 문장 1<br>수행할 문장 2<br>...<br>elif : <br> 수행할 문장 a<br>수행할 문장 b<br> ...<br>else : <br> 수행할 문장 A<br>수행할 문장 B<br> ... | <ul>위의 if문부터 조건을 하나씩 판단합니다. 조건문이 참일 경우 해당 명령어들을 수행하고 if문을 종료합니다.</ul><br><ul>예를 들어 첫 번째 if문이 참이라면 수행할 문장 1, 2를 수행하고 종료합니다.</ul><br><ul>하지만 첫 번째 if문이 거짓이면 다음 elif문의 조건을 판단합니다. 여기서 참이면 수행할 문장 a, b를 수행하고 종료하지만, 거짓이라면 다음 조건으로 넘어갑니다. elif는 개수의 제한 없이 사용할 수 있습니다.</ul><br><ul>else는 위의 조건이 모두 거짓일 경우에 사용되는 것으로 필요하다면 사용하고 필요없으면 생략해도 됩니다. |
| :--------------- | ------- |

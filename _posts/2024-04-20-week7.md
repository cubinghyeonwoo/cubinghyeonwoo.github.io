...
| 연산자 | 의미 | 사용 예 |
| :--------------- | ------- | ------- | 
| in | 특정 값이 반복 가능한 데이터에<br>있으면 True, 없으면 False | x in 리스트<br>x in 튜플<br>x in 문자열 |
| not in | 특정 값이 반복 가능한 데이터에<br>없으면 True, 있으면 False | x in 리스트<br>x in 튜플<br>x in 문자열 |
